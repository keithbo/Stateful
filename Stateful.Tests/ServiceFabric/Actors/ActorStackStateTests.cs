namespace Stateful.ServiceFabric.Actors
{
    ...
    public class ActorStackStateTests
    {
        [Fact]
        ...
        [Fact]
        public async Task TryPopAsync_When_NoStateTest()
        {
            var stateManager = new MockActorStateManager();
            var keyMock = new Mock<IStateKey>();
            keyMock.Setup(x => x.ToString()).Returns("TestName");
        ...
        [Fact]
        public async Task TryPopAsync_When_NoValuesTest()
        {
            var stateManager = new MockActorStateManager();
            var keyMock = new Mock<IStateKey>();
            keyMock.Setup(x => x.ToString()).Returns("TestName");
        ...
        [Fact]
        public async Task TryPopAsync_MultipleValuesTest()
        {
            var stateManager = new MockActorStateManager();
            var keyMock = new Mock<IStateKey>();
            keyMock.Setup(x => x.ToString()).Returns("TestName");
            ...
            result = await state.TryPopAsync(cts.Token);
            Assert.True(result.HasValue);
        ...
        public async Task RoundTripTest()
        {
            ...
            {
                await state.PushAsync(value, cts.Token);
            }
